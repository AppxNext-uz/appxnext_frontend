                    ...
                    <div className="mt-[100px] lg:p-0 p-[15px]">
                        ...
                        <div className="mt-[50px] flex justify-between items-center flex-wrap gap-[10px] lg:gap-[0px]">
                            <div className="border-2 shadow-2xl border-[#4A494E] hover:-translate-y-1 transition-all rounded-2xl py-[35px] px-[20px] w-fit">
                                <img src={"https://cdn-icons-png.flaticon.com/512/1875/1875043.png"} alt="logo" className="h-[100px] w-[100px] rounded-xl object-cover py-[10px] px-[10px] bg-[#34333B]" />
                                <h1 className="text-xl text-white font-[700] mt-[20px]">Mobil ilovalar</h1>
                                <p className="max-w-[370px] text-[18px] mt-[10px]">Zamonaviy, qulay, chiroyli qisqa qilib aytganda siz xohlagandek mobil ilovalar va juda tez fursatlarda.</p>
                            ...
                            <div className="border-2 shadow-2xl border-[#4A494E] hover:-translate-y-1 transition-all rounded-2xl py-[35px] px-[20px] w-fit">
                                <img src={'https://cdn-icons-png.flaticon.com/512/5612/5612989.png'} alt="logo" className="h-[100px] w-[100px] rounded-xl object-cover py-[10px] px-[10px] bg-[#34333B]" />
                                <h1 className="text-xl text-white font-[700] mt-[20px]">Web saytlar</h1>
                                <p className="max-w-[370px] text-[18px] mt-[10px]">So'nggi texnologiyalardan foydalangan holda, xohlagan qiyinchilikdagi sizga kerakli web saytlarni siz xohlagandek qilib qilib beramiz.</p>
                                <div className="mt-[20px] border-2 border-[#4A494E] hover:text-black cursor-pointer rounded-lg hover:bg-white hover:border-0 transition-all flex justify-center items-center h-[60px] w-[60px]">
                                    <i class="fa-solid text-lg fa-chevron-right"></i>
                                </div>
                            </div>
